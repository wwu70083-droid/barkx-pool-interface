...
import orderbookArtifact from "./BarkXOrderbook.json" with { type: "json" };
import erc721BatchTransferArtifact from "./ERC721BatchTransfer.json" with { type: "json" };
...
export const BarkXOrderbookAbi = extractAbi(orderbookArtifact);
export const ERC721BatchTransferAbi = extractAbi(erc721BatchTransferArtifact);
