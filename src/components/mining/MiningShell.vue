  ...
  <div>
    ...
    <nav
      ...
      :class="{
        ...
        'show-level-bark-ai': navLevel === 'bark-ai',
    ...
    >
      <div class="nav-levels-wrapper">
        ...
        <div id="nav-level-bark-ai" class="nav-level">
          <button
            class="nav-back-btn"
            type="button"
            @click="showNavLevel1"
          >
            ...
            <span class="nav-back-label">BarkAI</span>
          </button>

          <a
            v-for="item in barkAiItems"
            :key="item.key"
            :href="item.href"
            target="_blank"
...
const navItems = computed(() => {
  return [
    { key: "bark-ai", type: "parent", navLevel: "bark-ai", label: "BarkAI", alwaysEnabled: true },
...
const barkAiItems = [
  { key: "barkx-chat", label: "BarkX Chat", href: "https://chat.barkx.xyz/" },
  { key: "barkx-assistant", label: "BarkX Assistant", href: "https://agent.barkx.xyz/" },
];
...
.side-nav.show-level-bark-ai #nav-level-1,
...
.side-nav.show-level-bark-ai #nav-level-bark-ai,
